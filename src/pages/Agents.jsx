...
const AGENT_BLURBS = {
  DocumentAnalyst:
    "Analyzes document structure and produces a readability report.",
    ...
    return (
      <div className="space-y-6">
        ...
        <SignInPrompt
          ...
          description="DocumentAnalyst, InvoiceAuditor, and more — available after sign-in."
        />
      </div>
    );
  }
          ...
          <Card className="p-6">
            <form onSubmit={onRun} className="space-y-4">
              ...
              <div className="flex justify-end">
                <Button
                  type="submit"
                  disabled={running || !selected || !input.trim()}
                >
